...
# Wallpaper
exec --no-startup-id feh --bg-scale /home/flash/Pictures/Mountains.jpg

# Lock screen
bindsym $mod+shift+x exec i3lock -i /home/flash/Pictures/Batman.png
# Screenshot using flamshot
